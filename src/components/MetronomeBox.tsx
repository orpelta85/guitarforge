  ...
  return (
    <div className="flex flex-col items-center gap-1" style={{ width: size + 16 }}>
      ...
      >
        ...
        <circle cx={r} cy={r} r={r-4} fill="url(#knobGradMet)"/>
      ...
      <span className="text-[11px] text-amber-400 font-mono">{value}</span>
    </div>
  );
}
        ...
        <div className="mb-3 space-y-3">
          ...
          <div className="grid grid-cols-4 gap-2 items-end">
            <div className="flex flex-col items-center">
              <RotaryKnob value={bpm} min={30} max={300} onChange={setBpmState} label="התחלה" size={44} />
            </div>
            <label
